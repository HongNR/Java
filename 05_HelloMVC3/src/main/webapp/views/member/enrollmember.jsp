...
<jsp:include page="/views/common/header.jsp"/>
	...
	<h2>회원 가입 정보 입력</h2>
        <form name="enrollMemberFrm" action="${pageContext.request.contextPath }/member/enrollMemberEnd.do" 
				...
				<script>
					const fn_idduplicate=()=>{
						...
						if(userId.trim().length<4){
							...
							duplicateIdFrm.action="${pageContext.request.contextPath}/member/idDuplicate.do";
